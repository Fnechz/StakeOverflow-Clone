...
class AskQuestionsTestCase(StaticLiveServerTestCase):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_can_ask_blank_question(self):
		...
		self.selenium.find_element_link_text("Ask").click()
...
class QuestionDetailViewTestCase(TestCase):
	...
	def test_logged_in_user_can_post_answers(self):
		...
		self.asssertInHTML(question_needle, rendered_content)



class DailyQuestionListListTestCase(TestCase):
	'''
